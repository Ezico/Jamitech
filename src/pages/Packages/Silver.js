    ...
    <>
      ...
      <div class="container">
        <div className="packages-details">
          <div className="packages-header">Silver Mid Package (3.5KVA)</div>
          <div className="packages-content row">
            <div className="p-5 col-xs-12 col-md-3 col-lg-3">
              <h3>Specification</h3>
              <ul>
                <li>3.5kva Pure Sine inverter x 1</li>
            ...
            <div className="p-5 col-xs-12 col-md-3 col-lg-3">
              ...
              <ul>
                ...
                <li>Laptop - 1 to 2</li>
                <li>Blender - 1</li>
                <li>Fridge (Inverter or average size) - 1</li>
              </ul>
            </div>
            <div className="p-5 col-xs-12 col-md-3 col-lg-3">
          ...
          <div className="packages-header">Silver Max Package (3.5KVA)</div>
          <div className="packages-content row">
            <div className="p-5 col-xs-12 col-md-3 col-lg-3">
              <h3>Specification</h3>
              <ul>
                ...
                <li> 300Watts Monocrystalline Solar panel x 8</li>
                <li>Battery rack x 1</li>
                <li>Installation accessories</li>
                <li>Delivery and installation service inclusive</li>
              </ul>
            ...
            <div className="p-5 col-xs-12 col-md-3 col-lg-3">
              ...
              <ul>
                ...
                <li>Fridge - 1</li>
                <li>Freezer - 1</li>
                <li>Washing machine (average size) - 1</li>
                <li>Pumping machine (below 1hp) - 1</li>
              </ul>
            </div>
            <div className="p-5 col-xs-12 col-md-3 col-lg-3">
              <h3>Backup duration:</h3>
