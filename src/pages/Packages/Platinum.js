...
export const Platinum = () => {
  return (
    <>
      <Hero hero="roomsHero">
        <Banner title="Platinum Packages">
      ...
      <div className="container">
        <div className="packages-header">Platinum Package (7.5KVA)</div>
        <div className="packages-content row">
          <div className="p-5 col-xs-12 col-md-3 col-lg-3">
            <h3>Specification</h3>
            <ul>
              <li>7.5kva Pure Sine inverter x 1</li>
          ...
          <div className="p-5 col-xs-12 col-md-3 col-lg-3">
            <h3>Prices</h3>
            <li>
              Price without solar - N2,300,000 <br />
              <Link to="/quote?Platinum">(Request a quote)</Link>
            </li>
            <li>
              Price with solar - N3,700,000 <br />
              <Link to="/quote?Platinum">(Request a quote)</Link>
            </li>
          </div>
        </div>
        ...
        <p>
          <br />
          <strong>WITHOUT SOLAR:</strong> This is an inverter and battery backup
          system without the inclusion of solar panels. PHCN or Generator will
          be the only source of charging. Its suitable if there is available
          PHCN or Generator power for average total of 10 hours daily.
        </p>
        <br />
        <p>
        ...
        <p>
          Installation commences within 24 to 48 hours upon receipt of payment.
        </p>
      </div>
    </>
  );
