    ...
    <>
      ...
      <div class="container">
        <div className="packages-details">
          <div className="packages-header">Diamond Mid Package (10KVA)</div>
          <div className="packages-content row">
            <div className="p-5 col-xs-12 col-md-3 col-lg-3">
              ...
              <ul>
                ...
                <li> 300Watts Monocrystalline Solar panel x 18</li>
            ...
            <div className="p-5 col-xs-12 col-md-3 col-lg-3">
              ...
              <li>
                Price with solar - N4,100,000 <br />
                <Link to="/quote?DiamondMid">(Request a quote)</Link>
              </li>
            </div>
          </div>
          ...
          <div className="packages-header">Diamond Max Package (10KVA)</div>
          <div className="packages-content row">
            <div className="p-5 col-xs-12 col-md-3 col-lg-3">
              <h3>Specification</h3>
              <ul>
                <li>10kva Pure Sine inverter x 1</li>
                <li>220AH 12V Tubular Battery x 12</li>
                <li> 300Watts Monocrystalline Solar panel x 24</li>
                <li>Battery rack x 1</li>
                <li>Installation accessories</li>
                <li>Delivery and installation service inclusive</li>
              </ul>
            ...
            <div className="p-5 col-xs-12 col-md-3 col-lg-3">
              ...
              <li>
                Price with solar - N5,700,000 <br />
                <Link to="/quote?DiamondMax">(Request a quote)</Link>
              </li>
            </div>
          </div>
