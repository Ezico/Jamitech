    ...
    <>
      ...
      <div className="container policy">
        ...
        <header class="section-header">
          <h3>Privacy Policy for JamiTech Energy Solutions Limited</h3>
          <div className="divider"></div>
        </header>
        <p>
          At JamiTech Energy Solutions Limited , accessible from
          www.jamitechenergy.com, one of our main priorities is the privacy of
          our visitors. This Privacy Policy document contains types of
          information that is collected and recorded by JamiTech Energy
          Solutions Limited and how we use it.
        </p>
        <p>
        ...
        <p>
          ...
          shared and/or collect in JamiTech Energy Solutions Limited . This
        ...
        <h3>Log Files</h3>
        <p>
          JamiTech Energy Solutions Limited follows a standard procedure of
        ...
        advertising partners of JamiTech Energy Solutions Limited . Third-party
        ad servers or ad networks uses technologies like cookies, JavaScript, or
        Web Beacons that are used in their respective advertisements and links
        that appear on JamiTech Energy Solutions Limited , which are sent
        directly to users' browser. They automatically receive your IP address
        when this occurs. These technologies are used to measure the
        effectiveness of their advertising campaigns and/or to personalize the
        advertising content that you see on websites that you visit. Note that
        JamiTech Energy Solutions Limited has no access to or control over these
        cookies that are used by third-party advertisers.
        <h3>Third Party Privacy Policies</h3>
        JamiTech Energy Solutions Limited 's Privacy Policy does not apply to
        ...
        participate in, and/or monitor and guide their online activity. JamiTech
        Energy Solutions Limited does not knowingly collect any Personal
